...
<script setup>
import { ref } from 'vue';
import ModalChips from '../persons/details/modals/ModalChips.vue';

const props = defineProps(['competences', 'id']);
const emit = defineEmits(['addChips', 'deleteChip']);
